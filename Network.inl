...
void Network::train(Optimizer<L>& _optimizer, const DataSet& _dataSet, unsigned _maxEpochs, unsigned _epochsBetweenReports, unsigned _minibatchSize)
{
    ...
    if (!context)
        ...
        trainGPU(_optimizer, _dataSet, _maxEpochs, _epochsBetweenReports, _minibatchSize);
...
template<typename L>
void Network::trainGPU(Optimizer<L>& _optimizer, const DataSet& _dataSet, unsigned _maxEpochs, unsigned _epochsBetweenReports, unsigned _minibatchSize)
{
//    _optimizer.loss.toGPU(context, deviceId);
