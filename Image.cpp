...
//            t(2, i, j) = t(2, i, j) / 255.0;
            ...
            t(0, i, j) = (t(0, i, j) / 255.0)*2.0 - 1.0;
            t(1, i, j) = (t(1, i, j) / 255.0)*2.0 - 1.0;
            t(2, i, j) = (t(2, i, j) / 255.0)*2.0 - 1.0;
        }
    }
...
//                    example.input(j, i) = temp / 255.0;
        ...
        std::cout << "Unable to open: MNIST/train-images.idx3-ubyte" << std::endl;
}
...
void LoadMNISTLabels(rna::DataSet& _data)
{
    ...
    if (file)
    {
        ...
        std::cout << "Unable to open: MNIST/train-labels.idx1-ubyte" << std::endl;
}
